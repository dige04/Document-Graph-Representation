...
# These questions are tested to show Graph outperforming Vector with good answers
FALLBACK_QUESTIONS = [
    ...
    "Thu nhập từ chuyển nhượng bất động sản chịu thuế như thế nào?",
    "Thuế suất ưu đãi 10% trong 15 năm áp dụng cho dự án nào?",
